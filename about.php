    ...
    <div class="about ">
        <div class="container d-flex flex-lg-row flex-column gap-4 p-4">
            <div class="content">
                ...
                <p>
                    We take pride in offering a comprehensive and innovative platform for easy and secure invoice registration and storage. At "Fawaturik," we believe that invoice management should be a simple and flexible task for everyone, whether they are small business owners or managers of large enterprises.
                </p>
